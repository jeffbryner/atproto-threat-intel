...
2. Enable APIs:
   gcloud services enable firestore.googleapis.com cloudkms.googleapis.com pubsub.googleapis.com run.googleapis.com
...
5. Create KMS Key Ring and Asymmetric Key:
   gcloud kms keyrings create slack-intel-poc --location=us-central1
   gcloud kms keys create slack-root-key --location=us-central1 --keyring=slack-intel-poc --purpose=asymmetric-signing --default-algorithm=ec-sign-p256-sha256

6. Get the Key Name and export it:
   # Note the name of the key version 1
   export KMS_KEY_NAME="projects/{PROJECT_ID}/locations/us-central1/keyRings/slack-intel-poc/cryptoKeys/slack-root-key/cryptoKeyVersions/1"

7. Set Slack OIDC Environment Variables:
   # Create a Slack App using slack_manifest.yaml and get your credentials
   export SLACK_CLIENT_ID="your-client-id"
   export SLACK_CLIENT_SECRET="your-client-secret"
   export SLACK_WORKSPACE_ID="T..." # Optional: restrict to a specific Slack Team ID
